...
- **Analyseur de vitesse** : lance des audits manuels ou planifiés, met en file d’attente les scans quand la limite est atteinte et applique vos seuils d’alerte par profil (desktop/mobile) pour identifier les goulets d’étranglement back-end. La carte « Expérience réelle » du tableau de bord agrège en parallèle les Web Vitals (LCP/FID/CLS), signale les dérives critiques et remonte les pages les plus mesurées pour relier données terrain et recommandations back-end.【F:sitepulse_FR/modules/speed_analyzer.php†L5-L133】【F:sitepulse_FR/modules/custom_dashboards.php†L1379-L1568】【F:sitepulse_FR/modules/custom_dashboards.php†L2350-L2423】
