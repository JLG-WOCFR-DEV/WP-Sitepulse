...
- **Analyseur de vitesse** : lance des audits manuels ou planifiés, met en file d’attente les scans quand la limite est atteinte et applique vos seuils d’alerte pour identifier les goulets d’étranglement back-end.【F:sitepulse_FR/modules/speed_analyzer.php†L5-L133】
...
- **Analyses par IA** : interroge l’API Gemini avec gestion des quotas/retry, met en cache les réponses, ajoute des variantes HTML et fournit des outils accessibles pour copier, noter et exporter les recommandations.【F:sitepulse_FR/modules/ai_insights.php†L1606-L1759】【F:sitepulse_FR/modules/js/sitepulse-ai-insights.js†L430-L516】【F:sitepulse_FR/modules/js/sitepulse-ai-insights.js†L746-L940】
...
- **Analyseur de journaux** : catégorise les entrées du `debug.log`, explique chaque gravité et guide l’activation du logging quand il est inactif.【F:sitepulse_FR/modules/log_analyzer.php†L4-L170】
...
- **Alertes d’erreurs** : surveille la charge CPU et les erreurs fatales, applique des seuils configurables, évite le spam via cooldown, et diffuse les alertes par e-mail ou webhooks filtrables.【F:sitepulse_FR/modules/error_alerts.php†L6-L140】【F:sitepulse_FR/modules/error_alerts.php†L560-L720】
...
- **Protection du debug log** : relocation automatique hors webroot quand les protections `.htaccess/web.config` sont ignorées, génération des fichiers de blocage et alertes si l’écriture échoue.【F:sitepulse_FR/sitepulse.php†L330-L379】【F:sitepulse_FR/sitepulse.php†L1360-L1480】
- **Nettoyage complet** : la routine `uninstall.php` supprime options, transients, tâches cron, signatures MU et capacités personnalisées pour laisser la base propre.【F:sitepulse_FR/uninstall.php†L14-L200】
