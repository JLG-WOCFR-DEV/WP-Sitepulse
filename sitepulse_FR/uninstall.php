...
$sitepulse_constants = [
    ...
    'SITEPULSE_OPTION_UPTIME_MAINTENANCE_WINDOWS' => 'sitepulse_uptime_maintenance_windows',
    'SITEPULSE_OPTION_UPTIME_MAINTENANCE_NOTICES' => 'sitepulse_uptime_maintenance_notices',
    ...
    'SITEPULSE_OPTION_AI_HISTORY'                 => 'sitepulse_ai_history',
    ...
    'SITEPULSE_TABLE_RESOURCE_MONITOR_HISTORY'        => 'sitepulse_resource_snapshots',
    ...
    'SITEPULSE_TRANSIENT_RUM_AGGREGATES'              => 'sitepulse_rum_aggregates',
    'SITEPULSE_TABLE_RUM_METRICS'                     => 'sitepulse_rum_metrics',
...
$options = [
    ...
    SITEPULSE_OPTION_AI_RETRY_AFTER,
    SITEPULSE_OPTION_AI_HISTORY,
    ...
    SITEPULSE_OPTION_UPTIME_KEYWORD,
    SITEPULSE_OPTION_UPTIME_REMOTE_QUEUE_METRICS,
    SITEPULSE_OPTION_UPTIME_MAINTENANCE_WINDOWS,
    ...
    SITEPULSE_OPTION_DASHBOARD_IMPACT_INDEX,
...
if (!function_exists('sitepulse_uninstall_drop_rum_table')) {
    ...
    function sitepulse_uninstall_drop_rum_table() {
        ...
        $table = $wpdb->prefix . SITEPULSE_TABLE_RUM_METRICS;
